...
- Name: legal-platform-slides.spec.ts >> Legal platform slides 3 and 4 >> desktop presentation shows legal platform intro, public website portal, and Shift practice mode
- Location: tests/legal-platform-slides.spec.ts:63:3
